...
public class FinalprojectTestContainer extends TestContainer {

    public FinalprojectTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/finalproject/app.properties",
    ...
    public static class Common extends FinalprojectTestContainer {

        public static final FinalprojectTestContainer.Common INSTANCE = new FinalprojectTestContainer.Common();
